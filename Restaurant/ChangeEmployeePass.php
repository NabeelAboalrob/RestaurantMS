...
include ('Connection.php');
   ...
   $o=@mysqli_query($Conn,"SELECT EPassword FROM Employee WHERE UserName='$name'");
   ...
   if($row['0']!=$Opass){
	   ...
	   if($Npass1!=$Npass2){echo"New Password Confirm Did not Match!";}else{
		   ...
		   @mysqli_query($Conn,"UPDATE Employee SET EPassword='$Npass1' WHERE UserName='$name';");
...
?>
  <div><a style="color:#333" href='EmpPage.php'>Back</a></div>
  <div>
